...
import { Loader2, Settings, Moon, Sun, RotateCcw, BookOpen, MessageSquare, Layers, LayoutDashboard, FlaskConical, Monitor, Rocket } from 'lucide-react'
          ...
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex flex-wrap items-center gap-2 md:gap-4">
              ...
              <Button
                ...
                size="sm"
                className="gap-1.5"
                onClick={() => { window.location.hash = '#/build-planner' }}
                title="Build Planner"
              >
                <Rocket size={16} />
