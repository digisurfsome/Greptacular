...
- system_prompt.md - Core operating protocol and file-based mode instructions.
...
## Settings
- settings/config.yml - Adjustable agent settings and safety thresholds

## Standards
- ../agent-os/standards/ui-ux-build-standards.md - Martin's Platform-Agnostic App Builder (UI/UX constitution)
