...
| `preview-machine/` | (Pipeline — not a page yet) | **Preview Site Machine** — scrape niche businesses, audit sites, generate preview sites, deploy to Cloudflare Pages. Subscription copywriter: `scripts/preview_machine/copywriter.py`. Handoff + sitegen `--copydir` patch spec inside |
