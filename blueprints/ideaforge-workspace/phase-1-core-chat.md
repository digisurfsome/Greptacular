# Phase 1: IdeaForge Workspace - Core Chat Infrastructure
...
```json
{"type": "token_usage", "total_tokens": 5432, "context_window": 200000}
```
...
1. **Start the server and verify the workspace endpoints exist:**
   ...
   - `GET /api/workspace/conversations/{id}/tokens` returns `{"total_tokens": 0, "context_window": 200000, "usage_percent": 0}`
...
5. **Token tracking:** After a response, verify you receive a `{"type": "token_usage", "total_tokens": N, "context_window": 200000}` message with N > 0.
